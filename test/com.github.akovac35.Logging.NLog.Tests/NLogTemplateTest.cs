...
namespace com.github.akovac35.Logging.NLog.Tests
{
    [TestFixture]
    public class NLogTemplateTest
    {
        [OneTimeSetUp]
        ...
        public static IEnumerable<object> LoggerMessage_IsCorrect_Cases()
        {
            ...
            yield return new TestCaseData(nameof(EnteringSimpleFormatValueTypes), EnteringSimpleFormatValueTypes).Returns("Entering: System.Object[]");
            ...
            yield return new TestCaseData(nameof(EnteringSimpleFormatValueTypesWithLogLevel), EnteringSimpleFormatValueTypesWithLogLevel).Returns("Entering: System.Object[]");

            Action<Microsoft.Extensions.Logging.ILogger> EnteringSimpleFormatMixedTypes = (l) => l.EnteringSimpleFormat(1, typeof(int), 3);
            yield return new TestCaseData(nameof(EnteringSimpleFormatMixedTypes), EnteringSimpleFormatMixedTypes).Returns("Entering: System.Object[]");
            ...
            yield return new TestCaseData(nameof(EnteringSimpleFormatMixedTypesWithLogLevel), EnteringSimpleFormatMixedTypesWithLogLevel).Returns("Entering: System.Object[]");
            ...
            yield return new TestCaseData(nameof(ExitingSimpleFormatValueTypes), ExitingSimpleFormatValueTypes).Returns("Exiting: System.Object[]");
            ...
            yield return new TestCaseData(nameof(ExitingSimpleFormatValueTypesWithLogLevel), ExitingSimpleFormatValueTypesWithLogLevel).Returns("Exiting: System.Object[]");

            Action<Microsoft.Extensions.Logging.ILogger> ExitingSimpleFormatMixedTypes = (l) => l.ExitingSimpleFormat(1, typeof(int), 3);
            yield return new TestCaseData(nameof(ExitingSimpleFormatMixedTypes), ExitingSimpleFormatMixedTypes).Returns("Exiting: System.Object[]");
            ...
            yield return new TestCaseData(nameof(ExitingSimpleFormatMixedTypesWithLogLevel), ExitingSimpleFormatMixedTypesWithLogLevel).Returns("Exiting: System.Object[]");
